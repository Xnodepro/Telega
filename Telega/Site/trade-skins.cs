...
namespace Telega.Site
{
    class trade_skins
    {
        ...
        public void INI(int index)
        {
            ...
            driver.Navigate().GoToUrl("https://trade-skins.com/");

            driver.Navigate().GoToUrl("https://trade-skins.com/authenticate");
         ...
         "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36");
            ...
            while (true)
            {
                try
                {
                    ...
                    var response = client.GetAsync("https://trade-skins.com/load_all_bots_inventory?hash=" + dataRequest).Result;
